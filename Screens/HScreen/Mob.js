...
Product()
 ...
 const Product = () =>{
 firestore().collection('Mobiles').get().then((snapshot)=>{
        ...
        <View style={styles.container}>
            <ScrollView horizontal={true}>
                <View style={{alignItems:'center',marginTop:5,flexDirection:'row'}}>
                 ...
                 <Image style={styles.ImageB} source={require('../../assets/real.jpg')}/>
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.Scroll}>
                 <Image  style={styles.ImageB} source={require('../../assets/IP.jpg')}/>
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.Scroll}>
                 <Image style={styles.ImageB} source={require('../../assets/SUM.jpg')}/>
                    </TouchableOpacity>
                </View>
            </ScrollView>
            <ScrollView horizontal={true}>
